...
// Import des composants (Assure-toi que les noms de fichiers correspondent sur ton disque)
    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-slate-100 p-4">
        <div className="bg-white p-8 rounded-3xl shadow-xl text-center max-w-md w-full border border-slate-200">
          ...
          <button 
            onClick={login} 
            className="w-full bg-slate-900 text-white py-4 rounded-2xl font-bold hover:bg-black transition-all transform active:scale-95 shadow-xl"
          >
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-800 font-sans">
      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between gap-4 overflow-x-auto">
          ...
          <div className="flex items-center gap-3 min-w-fit">
             ...
             <div className="hidden lg:block">
               <h1 className="text-sm font-black text-slate-800 leading-tight">Budget {currentYear}</h1>
